---
title: "Geographical Weighted Regression"
...
```{r}
mpsz = st_read(dsn = "../../data/geospatial/MP14_SUBZONE_WEB_PL", layer = "MP14_SUBZONE_WEB_PL")
```
...
## 7.1 EDA using statistical graphs
...
```{r}
tmap_options(check.and.fix = TRUE) # Somehow fixes an error
