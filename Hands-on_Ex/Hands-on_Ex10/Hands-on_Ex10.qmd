...
![On the other hands, most of the modelling packages in R is expecting a matrix look similar to the figure below.](images/clipboard-2888429926.png)

![](images/clipboard-3820713295.png)
...
# 6 Modelling and Visualizing Accessibility using Hansen Method
...
![](https://r4gdsa.netlify.app/chap17/img/image3.jpg)The default field name is very messy, we will rename it to `accHansen` by using the code chunk below.
...
# 8 Modelling and Visualizing Accessibility using Spatial Accessibility Measure (SAM) method
