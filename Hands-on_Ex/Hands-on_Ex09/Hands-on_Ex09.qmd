...
```{r}
mdata <- read_rds("../../data/rds/Hands-on_Ex09/mdata.rds")
```
...
```{r}
write_rds(train_data, "../../data/rds/Hands-on_Ex09/train_data.rds")
write_rds(test_data, "../../data/rds/Hands-on_Ex09/test_data.rds")
```
...
```{r}
train_data <- read_rds("../../data/rds/Hands-on_Ex09/train_data.rds")
test_data <- read_rds("../../data/rds/Hands-on_Ex09/test_data.rds")
```
...
```{r}
write_rds(price_mlr, "../../data/rds/Hands-on_Ex09/price_mlr.rds" ) 
```
...
```{r}
#| eval: False
write_rds(bw_adaptive, "../../data/rds/Hands-on_Ex09/bw_adaptive.rds")
```
...
```{r}
bw_adaptive <- read_rds("../../data/rds/Hands-on_Ex09/bw_adaptive.rds")
```
...
```{r}
#| eval: False
write_rds(gwr_adaptive, "../../data/rds/Hands-on_Ex09/gwr_adaptive.rds")
```
...
```{r}
gwr_adaptive <- read_rds("../../data/rds/Hands-on_Ex09/gwr_adaptive.rds")
```
...
Before continuing, we write all the output into rds for future usage

```{r}
#| eval: false
coords_train <- write_rds(coords_train, "../../data/rds/Hands-on_Ex09/coords_train.rds" )
coords_test <- write_rds(coords_test, "../../data/rds/Hands-on_Ex09/coords_test.rds" )
```
...
```{r}
#| eval: false
write_rds(rf, "../../data/rds/Hands-on_Ex09/rf.rds")
```

```{r}
#| eval: false
rf <- read_rds("../../data/rds/Hands-on_Ex09/rf.rds")
rf
```
...
```{r}
#| eval: false
write_rds(gwRF_adaptive, "../../data/rds/Hands-on_Ex09/gwRF_adaptive.rds")
```
...
```{r}
#| eval: false
gwRF_adaptive <- read_rds("../../data/rds/Hands-on_Ex09/gwRF_adaptive.rds")
```
...
```{r}
#| eval: false
GRF_pred <- write_rds(gwRF_pred, "../../data/rds/Hands-on_Ex09/GRF_pred.rds")
```
...
```{r}
#| eval: false
GRF_pred <- read_rds("../../data/rds/Hands-on_Ex09/GRF_pred.rds")
...
```{r}
#| eval: false
write_rds(test_data_p, "../../data/rds/Hands-on_Ex09/test_data_p.rds")
```
