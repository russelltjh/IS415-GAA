...
```{r}
saveRDS(hexagon_Hansen, "data/rds/hexagon_Hansen.rds")
saveRDS(hexagon_KD2SFCA, "data/rds/hexagon_KD2SFCA.rds")
saveRDS(hexagon_SAM, "data/rds/hexagon_SAM.rds")

saveRDS(schools_sf, "data/rds/schools_sf.rds")
saveRDS(MRT_sf, "data/rds/MRT_sf.rds")
saveRDS(mall_sf, "data/rds/mall_sf.rds")
saveRDS(supermarket_sf, "data/rds/supermarket_sf.rds")
saveRDS(hawker_sf, "data/rds/hawker_sf.rds")

saveRDS(mapex, "data/rds/mapex.rds")
```
